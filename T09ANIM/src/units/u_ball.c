...
{
  NM6_RndPrimLoad(&Uni->Cow, "BIN/MODELS/.obj");
...
{
  NM6_RndPrimDraw(&Uni->Cow, MatrMulMatr3(Uni->Cow, MatrTranslate(Uni->Pos), MatrRotateX(-90)));
